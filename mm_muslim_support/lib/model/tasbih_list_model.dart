...
class TasbihListModel {
  ...
  TasbihListModel({
    ...
    required this.tasbihDetailDataList,
  });
}
...
List<TasbihListModel> tasbihListModel = [
  TasbihListModel(
    ...
    rewards: '',
    tasbihDetailDataList: _tasbihDetailDataList,
  ),
  TasbihListModel(
    title: 'Subhanallah',
    rewards: '',
