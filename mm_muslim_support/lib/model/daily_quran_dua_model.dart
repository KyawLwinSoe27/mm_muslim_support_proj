...
final List<DailyQuranDuaModel> dailyQuranList = [
  DailyQuranDuaModel(
  ...
  DailyQuranDuaModel(
    ...
    mmTranslation: '',
    reference: 'Surah Taha, Verse 114',
  ),
  DailyQuranDuaModel(
  ...
  DailyQuranDuaModel(
    ...
    mmTranslation: '',
    reference: 'Surah Al-Baqarah, Verse 255 (Ayat al-Kursi)',
  ),
  DailyQuranDuaModel(
    arabic: 'رَبِّ إِنِّي لِمَا أَنزَلْتَ إِلَيَّ مِنْ خَيْرٍ فَقِيرٌ',
    translation: 'My Lord, indeed I am, for whatever good You would send down to me, in need.',
    mmTranslation: '',
    reference: 'Surah Al-Qasas, Verse 24',
  ),
  DailyQuranDuaModel(
...
final List<DailyQuranDuaModel> dailyDuaList = [
  DailyQuranDuaModel(
  ...
  DailyQuranDuaModel(
    ...
    translation: 'O Allah, forgive me all my sins, the minor and the major, the first and the last, the public and the private.',
    mmTranslation: '',
  ...
  DailyQuranDuaModel(
    arabic: 'رب اجعلني مقيم الصلاة ومن ذريتي.',
    translation: 'My Lord, make me an establisher of prayer, and many from my descendants.',
    mmTranslation: '',
    reference: 'Surah Ibrahim, Verse 40',
  ),
  ...
  DailyQuranDuaModel(
    ...
    translation: 'O Allah, I seek refuge with You from the removal of Your blessing, the loss of well-being, Your sudden punishment, and all forms of Your wrath.',
    mmTranslation: '',
    reference: 'Hadith - Muslim',
  ),
  DailyQuranDuaModel(
    arabic: 'اللهم آتنا في الدنيا حسنة وفي الآخرة حسنة وقنا عذاب النار.',
    translation: 'Our Lord, give us in this world [that which is] good and in the Hereafter [that which is] good and protect us from the torment of the Fire.',
    mmTranslation: '',
    reference: 'Surah Al-Baqarah, Verse 201',
  ),
  DailyQuranDuaModel(
    arabic: 'اللهم إنّي أسألك العفو والعافية.',
