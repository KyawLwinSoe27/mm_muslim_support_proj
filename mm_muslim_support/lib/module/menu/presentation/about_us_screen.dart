...
class AboutUsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('About Us', style: context.textTheme.titleLarge?.copyWith(color: context.colorScheme.onSecondary, fontWeight: FontWeight.w500))),
      body: Padding(
        padding: const EdgeInsets.all(20.0),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Minara', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
            ...
            ].map((e) => Padding(padding: const EdgeInsets.only(bottom: 6.0), child: Text(e))),
            const SizedBox(height: 20),
