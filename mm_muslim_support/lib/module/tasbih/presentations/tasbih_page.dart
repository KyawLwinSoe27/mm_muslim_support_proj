...
class TasbihPage extends StatelessWidget {
    ...
    return Scaffold(
      body: BlocConsumer<TasbihCounterCubit, TasbihCounterState>(
        listener: (context, state) {
          context.read<TasbihCounterCubit>().total =
              tasbih[state.tasbihIndex].count;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    tasbih[state.tasbihIndex].translation,
                    style: const TextStyle(fontSize: 16),
                  ),
                  const SizedBox(height: 30),
                  GestureDetector(
                    onTap:
                        () => context.read<TasbihCounterCubit>().increment(
                          state.tasbihIndex,
                        ),
                    child: Container(
                      width: 200,
  ...
  Widget _buildIconButton(
    ...
    return CircleAvatar(
      radius: radius,
      backgroundColor: const Color(0xFF3C6950),
      child: IconButton(
